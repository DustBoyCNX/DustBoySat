...
extern {
  ...
  #[link_name = "getPm10"]      fn _getPm10() -> u32;
  #[link_name = "getPm1"]      fn _getPm1() -> u32;
  #[link_name = "getPm2_5"]      fn _getPm2_5() -> u32;
  #[link_name = "getGreeting"]    fn _getGreeting(utf8: * mut u8, maxlen: usize);
  #[link_name = "print"]          fn _print(utf8: *const u8, len: usize);
  #[link_name = "rawSerialOut"]   fn _rawSerialOut(value: u32);
...
pub fn rawSerialOut (value: u32) { unsafe { _rawSerialOut(value) } }
pub fn getPinLED      () -> u32               { unsafe { _getPinLED() } }
pub fn getPm10      () -> u32               { unsafe { _getPm10() } }
pub fn getPm1      () -> u32               { unsafe { _getPm1() } }
pub fn getPm2_5      () -> u32               { unsafe { _getPm2_5() } }
